$serverRunning = $false
# ⚠️ CHANGE THIS to the actual folder where your server.js is located
$folderPath = "D:\QuickBillPOS" 

while ($true) {
    # Check if Tally or TallyPrime is running
    ...
    # Pause for 5 seconds before checking again (keeps it extremely lightweight)
